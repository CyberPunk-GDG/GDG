      ...
      <div className="container px-4 mx-auto relative text-sm">
        <div className="flex justify-between items-center">
          ...
          <ul className="hidden lg:flex ml-14 space-x-12">
            ...
            <li><button onClick={() => handleNavigation("/features", "features")} className="hover:text-gray-600">Features</button></li>
        ...
        {mobileDrawerOpen && (
          <div className="fixed right-0 z-20 bg-neutral-900 w-full p-12 flex-col justify-center item-center lg:hidden">
            <ul>
              ...
              <li className="py-4"><button onClick={() => handleNavigation("/features", "features")} className="hover:text-gray-600">Features</button></li>
